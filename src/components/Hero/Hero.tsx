...
const HeroSection = styled.section`
  background-image: url('/images/bmw.jpg'); /* Ваше фоновое изображение */
    ...
    <HeroSection id="home">
      <div className="container">
        <HeroContainer>
          <HeroContent>
            <HeroTitle>
              Мотоциклы <span>BMW</span> - легендарное качество
            </HeroTitle>
            <HeroSubtitle>
              BMW - это более 100 лет инноваций и страсти к мотоциклам. Выберите свой идеальный мотоцикл из линейки легендарного немецкого бренда.
            </HeroSubtitle>
            <ButtonGroup>
              <WhatsAppButton href="https://wa.me/79203383324?text=Здравствуйте,%20интересует%20каталог%20мотоциклов%20BMW" target="_blank" rel="noopener noreferrer">
